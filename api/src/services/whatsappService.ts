...
export const sessions = new Map<string, ReturnType<typeof makeWASocket>>();
export const qrCodes = new Map<string, string>(); // tenantId -> current QR

const logger = pino({ level: 'silent' }) as any;

export async function startWhatsAppSession(tenantId: string) {
...
export function logoutSession(tenantId: string) {
