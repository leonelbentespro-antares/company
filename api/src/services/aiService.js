...
export const MANAGE_CONVERSATION_TOOL = {
...
export const CONSULT_PROCESS_TOOL = {
...
export const ALL_TOOLS = [MANAGE_CONVERSATION_TOOL, CONSULT_PROCESS_TOOL];
/**
 * Chama o modelo Gemini para processar a mensagem do usuário com RAG local.
 */
export async function getAIResponse(userMessage, tenantContext) {
    try {
 ...
 */
export async function generateDocumentComGenAI(documentType, context) {
    try {
