...
export const verifySupabaseJWT = (req: Request, res: Response, next: NextFunction): void => {
...
export const extractTenant = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    if (!req.userId) {
    ...
    try {
        ...
        req.tenantId = data.tenant_id as string;
        next();
    } catch (err) {
...
export const verifyMetaHMAC = (req: Request, res: Response, next: NextFunction): void => {
